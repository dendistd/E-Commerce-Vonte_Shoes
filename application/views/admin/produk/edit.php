...
<div class="form-group">
  ...
  <div class="col-md-8">
    <input type="number" name="harga" class="form-control" placeholder="Harga" value="<?php echo $produk->harga ?>" min="0"  required>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-8">
    <input type="number" name="stok" class="form-control" placeholder="Stok" value="<?php echo $produk->stok ?>" min="0" required>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-8">
    <select name="ukuran" class="form-control">
      ...
      <option value="38" <?php if ($produk->ukuran=="38") {echo "selected";} ?>>Size 38</option>
      <option value="39" <?php if ($produk->ukuran=="39") {echo "selected";} ?>>Size 39</option>
      <option value="40" <?php if ($produk->ukuran=="40") {echo "selected";} ?>>Size 40</option>
      <option value="41" <?php if ($produk->ukuran=="41") {echo "selected";} ?>>Size 41</option>
    </select>
  </div>
</div>
